      ...
      <div className="bg-gradient-to-br from-cyan-900 to-green-700 lg:col-span-4">
        ...
        <div className="flex flex-col items-center justify-center py-2 lg:min-h-screen">
          <div className="relative rounded-xl bg-gradient-to-br from-yellow-400 to-cyan-600 p-2">
            <img
              className="w-44 rounded-xl object-cover transition duration-300 ease-in-out hover:animate-rotate-y lg:h-96 lg:w-72"
          ...
          <div className="space-y-2 p-5 text-center">
            <h1 className="text-4xl font-bold text-white">
              <span className="animate-bounce">P</span>APAFAM Apes
            </h1>
